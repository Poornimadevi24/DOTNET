    ...
    public class Generic_List
    {
...

        {
            ...
            Console.WriteLine("--------------Display details of all the employee whose location is not Mumbai------------------");
               var notMumbai = empList.FindAll(e => e.City != "Mumbai");
            ...
            var asstMgr = empList.FindAll(e => e.Title == "AsstManager");

            foreach (var e in asstMgr)
            ...
            var lastNameS = empList.FindAll(e => e.LastName.StartsWith("S"));
